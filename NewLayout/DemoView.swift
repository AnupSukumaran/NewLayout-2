...
class DemoView: UIView {
    ...
    func complexShape() {
       ...
       // path.addLine(to: CGPoint(x: self.frame.size.width - 80 , y: 0.0))
        ...
        path.addArc(withCenter: CGPoint(x: self.frame.size.width - 17 , y: 17.0),
                    radius: 17.0,
                    startAngle: CGFloat(270.0).degreesToRadians,
...
//                      controlPoint2: CGPoint(x: self.frame.size.width - 150.0, y: 50.0))
       ...
       //  path.addLine(to: CGPoint(x: self.frame.size.width, y: self.frame.size.height))
        ...
        path.addArc(withCenter: CGPoint(x: self.frame.size.width - 17, y: self.frame.size.height - 17.0),
                    ...
                    endAngle: CGFloat(120.0).degreesToRadians,
                    clockwise: true)
        
       // path.addLine(to: CGPoint(x: 0.0, y: self.frame.size.height/2 + 100))
        
        path.addArc(withCenter: CGPoint(x: 17, y:  self.frame.size.height/2 + 115),
                    radius: 17.0,
                    startAngle: CGFloat(120.0).degreesToRadians,
